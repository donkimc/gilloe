...
export const briefing = {
  ...
  money:
    "💰 성준은 가상 동네 퍼즐 행사의 일부가 빠져 나간 사실을 알고, 증거 자료를 ✉️ 파란 봉투에 담아 두었습니다. 그날 저녁 세 사람과 시간을 정해 두었습니다.",
...
export const suspects = [
  ...
  },
  {
    ...
    name: "서유나",
    role: "행사 일러스트레이터",
    claim: "🕖 7시 31분에 ✉️ 파란 봉투를 전하고 바로 떠났다.",
    cue: "🟨 노란 우산",
  },
  {
    id: "lee-do-yun",
...
export const cameraCopy = {
  ...
  beforeStartHint: "후면 카메라를 켠 뒤 주변을 천천히 비추세요. 남색 우산은 화면이 아니라 공간에 고정되어 보입니다.",
  overlayHint: "휴대폰을 돌리면 남색 우산이 현실 공간에 머무른 것처럼 보입니다. 우산을 찾아 탭하세요.",
...
export const ending = {
  title: "재구성",
  panels: [
    "✉️ 서유나는 19:31 약속대로 파란 봉투를 전하고 19:32경 자리를 뜹니다.",
    "☂️ 강민재는 🚇 역으로 갔다고 했지만, 19:38 반영에는 그의 남색 우산이 작업실 쪽에 남아 있습니다.",
...
export const stops = [
  {
    ...
    witnessCard:
      "📝 수첩 메모: 19:31 Y · ✉️ 파란 봉투 / 19:38 M · 💬 마지막 이야기 / 19:45 D · 📦 전달.",
  ...
  },
  {
    ...
    notebookEntry: "📷 19:38 반영: ☂️ 남색 우산. 민재의 🚇 역 알리바이와 충돌한다.",
    cameraClue: {
      enabled: true,
      framingInstruction:
      ...
      fallbackTitle: "🖼️ 정적 단서 · 카메라 없음",
      fallbackClue: "🪟 가상 유리 반영. 시각 19:38. ☂️ 남색 우산이 작업실 쪽에 비칩니다. 실제 장소의 사진이 아닙니다.",
    },
    puzzle: {
      type: "hotspot",
      prompt: "🖼️ 가상 증거 이미지에서 알리바이를 흔드는 물건을 고르세요.",
      hint: "💡 이미 떠났다고 말한 사람의 물건은 무엇인가요?",
      choices: [
        { id: "yellow-umbrella", label: "🟨 노란 우산", wrong: "❌ 유나의 우산입니다. 민재의 알리바이와는 다릅니다." },
        { id: "navy-umbrella", label: "☂️ 남색 우산", wrong: "" },
        { id: "red-cap", label: "🧢 빨간 모자", wrong: "❌ 도윤의 모자입니다. 도착은 더 늦습니다." },
      ],
      solution: "navy-umbrella",
      success: "✅ 19:38 반영의 ☂️ 남색 우산은, 민재가 그때 🚇 역에 있었다는 말과 맞지 않습니다.",
    },
  },
  {
    id: "stop-3",
    ...
    witnessCard: "🟨 유나 19:32 이탈, ☂️ 민재 19:38 반영, 🧢 도윤 19:45 도착 기록이 있습니다.",
    evidenceCard: "🧩 가장 이른 시각부터 세 장을 배열하세요.",
    notebookEntry: "🕖 시간순: 유나 19:32 ✉️ → 민재 19:38 ☂️ → 도윤 19:45 🚪.",
    puzzle: {
      type: "order",
      ...
      items: [
        ...
        { id: "yu-na-732", label: "🟨 서유나, ✉️ 봉투를 전하고 19:32에 떠남" },
        { id: "min-jae-738", label: "☂️ 강민재, 19:38 반영에 남색 우산" },
      ],
  ...
  },
  {
    ...
    safeStandingNote: "🍽️ 식사의 유무와 무관하게, 공개 보행 공간에서 마지막 질문을 푸세요.",
    scene: "✉️ 파란 봉투 안의 가상 장부 조각이 빠진 행사 자금과 민재를 잇습니다.",
    witnessCard: "📒 장부 메모: 행사 잔액 부족 · 처리 담당 ☂️ 강민재. 실제 거래가 아닙니다.",
    evidenceCard: "⚖️ 범인, 동기, 알리바이를 깨는 증거를 고르세요.",
    notebookEntry: "💰 가상 장부: 빠진 자금의 처리 담당이 민재로 적혀 있다.",
    puzzle: {
      type: "accusation",
      prompt: "⚖️ 세 가지를 고르세요. 틀린 항목만 다시 고치면 됩니다.",
    },
  },
];
...
export const accusation = {
  ...
  fields: [
    ...
    },
    {
      ...
      notebookHint: "✉️ 파란 봉투의 가상 장부를 보세요.",
    },
    {
      id: "evidence",
